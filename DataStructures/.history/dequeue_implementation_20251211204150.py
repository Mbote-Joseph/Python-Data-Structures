class Dequeue:
    ...
    # EARLIEST ADDED = START (LEFT SIDE)
    def add_at_start(self, data):
        if not self.isFull():
            # Start is left side → insert BEFORE earliest = appendleft
    ...
    def add_at_end(self, data):
        if not self.isFull():
            # End is right side → append as newest item
